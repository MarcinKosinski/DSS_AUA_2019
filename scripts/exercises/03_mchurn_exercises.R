...
# History
# 1) A user starts with a subscription with > 1 product                                       - initial state 1)
# 2) A user can delay the subcription (users that delayed subscription at least once)         - 1 -> 2
# 3) A user can reduce the number of products in the subscription so that he is left with one - 1 -> 3
...
# NOW GO TO THE PROJECT for MCHURN